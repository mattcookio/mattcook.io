...
### MBA, Data Analytics and Business Intelligence (4.0 GPA)
*July 2019*
- Lucas Sterne & Albert G. Spaeth Graduate Business Scholarship
- Graduate Student Achievement Award

### BM, Jazz/Commercial Music
*May 2017*
- UCM Music Dept. "Outstanding Senior" Award

## Skills + Strengths

**Strengths:** Software Architecture, CI/CD and Dev-Ops, UX Awareness, Manual and Automated Testing, Practical knowledge of AI (both usage/prompting, and implementing app features using AI services), Asking Questions, Pragmatism, Kindness, Enthusiasm

**Languages, Tools, Frameworks:** Full-Stack Typescript + Javascript, Neovim, React, GraphQL, Vue, Svelte, Next.js, Nest.js, Material UI, Tailwind, Docker, PostgreSQL, AWS, Gulp, Express, Sass, CSS, Golang, Python, and more

## Professional Experience

### Lead Software Engineer, Brightway Insurance
*August 2024 - Present*

### Co-Founder & CTO, Hively
...
- Built a robust, flexible, maintainable, multi-tenant solution from the ground up using Typescript, Node, and React, including:
  - The ability for partners to white-label the entire solution
  - Event-based request and notification infrastructure, serving various needs of clients and their residents
  - Calendar, event, attendee and organizer management
  ...
  - Public portal for users to enroll in athletics programs and track their events
  - Automated E2E testing
  - CI/CD pipeline for safe and lightning fast release cycle
  - A customer facing API for critical functions of the app
...
### Software Engineer III, EquipmentShare
*July – October 2021*
...
### Team Lead, Kansas City Pet Project
...
### OSS Developer, Code For America (KCMO)
...
### Tech Coach, KC Public Library / LaunchCode
*April 2019*
